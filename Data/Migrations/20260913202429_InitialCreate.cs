        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DemoPasswordHint = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AvailabilityWindows_Mentors_MentorId",
                        column: x => x.MentorId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bookings_Topics_TopicId",
                        column: x => x.TopicId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MentorTopics", x => new { x.MentorId, x.TopicId });
                    table.ForeignKey(
                        name: "FK_MentorTopics_Mentors_MentorId",
                        column: x => x.MentorId,
                        principalTable: "Mentors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MentorTopics_Topics_TopicId",
                        column: x => x.TopicId,
                        principalTable: "Topics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AvailabilityWindows_MentorId",
                table: "AvailabilityWindows",
                column: "MentorId");

            migrationBuilder.CreateIndex(
                name: "IX_Bookings_MentorId_StartUtc",
                table: "Bookings",
                columns: new[] { "MentorId", "StartUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_Bookings_TopicId",
                table: "Bookings",
                column: "TopicId");

            migrationBuilder.CreateIndex(
                name: "IX_MentorTopics_TopicId",
                table: "MentorTopics",
                column: "TopicId");
